library angular2.src.core.compiler.template_normalizer;
...
class TemplateNormalizer {
  ...
  CompileTemplateMetadata normalizeLoadedTemplate(
    ...
    var allStyleAbsUrls = (new List.from(ListWrapper
        .filter(visitor.styleUrls, isStyleUrlResolvable)
        .map((url) => this._urlResolver.resolve(templateAbsUrl, url))
        .toList())
      ..addAll(ListWrapper
          .filter(templateMeta.styleUrls, isStyleUrlResolvable)
