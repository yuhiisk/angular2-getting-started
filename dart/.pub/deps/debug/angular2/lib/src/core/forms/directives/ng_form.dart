library angular2.src.core.forms.directives.ng_form;
...
class NgForm extends ControlContainer implements Form {
  ...
  NgForm(@Optional() @Inject(NG_VALIDATORS) List<Function> validators)
      : super() {
  ...
  /** @internal */
  void _later(fn) {
    PromiseWrapper.then(PromiseWrapper.resolve(null), fn, (_) {});
  }
}
