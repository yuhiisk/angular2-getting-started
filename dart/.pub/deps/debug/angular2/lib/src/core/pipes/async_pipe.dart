library angular2.src.core.pipes.async_pipe;
...
import "package:angular2/src/core/facade/async.dart"
    show Future, ObservableWrapper, Stream;
...
class AsyncPipe implements PipeTransform, PipeOnDestroy {
  ...
  /** @internal */
  dynamic /* Stream | Future < dynamic > */ _obj = null;
  ...
  dynamic transform(dynamic /* Stream | Future < dynamic > */ obj,
      [List<dynamic> args]) {
  ...
  /** @internal */
  void _subscribe(dynamic /* Stream | Future < dynamic > */ obj) {
    this._obj = obj;
  ...
  /** @internal */
  dynamic _selectStrategy(dynamic /* Stream | Future < dynamic > */ obj) {
    if (isPromise(obj)) {
