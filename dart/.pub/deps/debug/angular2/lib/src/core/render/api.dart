...
import "package:angular2/src/core/facade/collection.dart" show Map;
...
abstract class RenderBeginCmd implements RenderTemplateCmd {
  num ngContentIndex;
  bool isBound;
}

abstract class RenderTextCmd implements RenderBeginCmd {
  String value;
}

abstract class RenderNgContentCmd {
...
abstract class RenderBeginElementCmd implements RenderBeginCmd {
  String name;
  List<String> attrNameAndValues;
  List<String> eventTargetAndNames;
}

abstract class RenderBeginComponentCmd implements RenderBeginElementCmd {
  bool nativeShadow;
  num templateId;
}

abstract class RenderEmbeddedTemplateCmd implements RenderBeginElementCmd {
  bool isMerged;
