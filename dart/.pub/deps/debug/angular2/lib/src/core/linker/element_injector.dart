...
class DirectiveDependency extends Dependency {
  ...
  static String _attributeName(properties) {
    var p = (ListWrapper.find(properties, (p) => p is AttributeMetadata)
        as AttributeMetadata);
    return isPresent(p) ? p.attributeName : null;
  }

  /** @internal */
  static QueryMetadata _query(properties) {
    return (ListWrapper.find(properties, (p) => p is QueryMetadata)
        as QueryMetadata);
  }
}
