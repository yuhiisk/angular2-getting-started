...
import "package:angular2/src/core/di.dart"
    show Injectable, Provider, resolveForwardRef, Inject;
...
class ProtoViewFactory {
  ...
  Map<num, AppProtoView> _cache = new Map<num, AppProtoView>();
  List<Type> _defaultPipes;
  String _appId;
  ProtoViewFactory(
      this._renderer,
      @Inject(DEFAULT_PIPES_TOKEN) List<Type> defaultPipes,
  ...
  AppProtoView _createComponent(BeginComponentCmd cmd) {
    ...
    if (isBlank(nestedProtoView)) {
      ...
      this._renderer.registerComponentTemplate(
          cmd.templateId,
          compiledTemplateData.commands,
      ...
      nestedProtoView = new AppProtoView(
          ...
          ViewType.COMPONENT,
          true,
          compiledTemplateData.changeDetectorFactory,
          null,
          ProtoPipes.fromProviders(boundPipes));
      // Note: The cache is updated before recursing

      // to be able to resolve cycles
      this._cache[cmd.template.id] = nestedProtoView;
